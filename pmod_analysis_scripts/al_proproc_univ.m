function al_proproc_univ(scriptPath, subNum)
...
runPath = fullfile(rundirs{ri});
scanfnames = dir(fullfile(subjPath,runPath, 'r4*.img'));
...
scanfnames = dir(fullfile(subjPath,runPath, 'mean*.img'));
refImage = {}; 
refImage = [refImage; ...
    reshape(strcat(runPath, '/', {scanfnames.name}, ',1'), [], 1)];    
...
matlabbatch{1}.spm.spatial.preproc.tissue(2).tpm = {'/Users/astrocyte/spm12/tpm/TPM.nii,2'};
matlabbatch{1}.spm.spatial.preproc.tissue(2).ngaus = 1;
matlabbatch{1}.spm.spatial.preproc.tissue(2).native = [1 0];
matlabbatch{1}.spm.spatial.preproc.tissue(2).warped = [0 0];
matlabbatch{1}.spm.spatial.preproc.tissue(3).tpm = {'/Users/astrocyte/spm12/tpm/TPM.nii,3'};
matlabbatch{1}.spm.spatial.preproc.tissue(3).ngaus = 2;
matlabbatch{1}.spm.spatial.preproc.tissue(3).native = [1 0];
matlabbatch{1}.spm.spatial.preproc.tissue(3).warped = [0 0];
matlabbatch{1}.spm.spatial.preproc.tissue(4).tpm = {'/Users/astrocyte/spm12/tpm/TPM.nii,4'};
matlabbatch{1}.spm.spatial.preproc.tissue(4).ngaus = 3;
matlabbatch{1}.spm.spatial.preproc.tissue(4).native = [1 0];
matlabbatch{1}.spm.spatial.preproc.tissue(4).warped = [0 0];
matlabbatch{1}.spm.spatial.preproc.tissue(5).tpm = {'/Users/astrocyte/spm12/tpm/TPM.nii,5'};
matlabbatch{1}.spm.spatial.preproc.tissue(5).ngaus = 4;
matlabbatch{1}.spm.spatial.preproc.tissue(5).native = [1 0];
matlabbatch{1}.spm.spatial.preproc.tissue(5).warped = [0 0];
matlabbatch{1}.spm.spatial.preproc.tissue(6).tpm = {'/Users/astrocyte/spm12/tpm/TPM.nii,6'};
...
runPath = fullfile(rundirs{ri});
scanfnames = dir(fullfile(subjPath,runPath, 'ar4*.img'));
...
runPath = fullfile(rundirs{ri});
scanfnames = dir(fullfile(subjPath,runPath, 'war4*.img'));

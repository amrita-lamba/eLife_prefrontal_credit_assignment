%% This script will calculate and plot framewise displacment
function mb_calc_FD(subNum,runxrun_correction,scriptPath)
...
if runxrun_correction == 0
    ...
    for ri = 1:4
        ...
        realignFile = struct2cell(realignFile);
        realignFile = realignFile(1,1); % error 
        realignFile = cell2mat(realignFile);
...
% can use this section if excessive motion at the beginning and end of run

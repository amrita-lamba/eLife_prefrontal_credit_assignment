%% Extract trial beta coeffs. during choice in the conjunction ROIs for the cross-timepoint RSA
...
output_folder = [pwd,'/Trialwise_Voxel_Betas/Choice_combined_GLM'];
...
for subIdx = 1:30
    ...
    for condition = 1:2
        ...
        [pred_RDM,conditionVec] = construct_pred_RDMs_RSA_trialwise_choice(subNum,condition,scriptPath,RDM_roi); % change this so you're only running relevant RDM

function userOptions = defineUserOptions_socialRisk(scriptPath)
%
...
userOptions.projectName = 'socialRisk_RSA';

% This name identifies a collection of files which all belong to the same run of a project.
userOptions.analysisName = 'model_RDMs';

% This is the root directory of the project.
userOptions.rootPath = scriptPath;
...
%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	%	userOptions.structuralsPath = 'paathToWhereYourSubject''s structuralImagesAreStored ';% e.g. /imaging/mb01/lexpro/[[subjectName]]/structurals/
    	...
    	userOptions.voxelSize = [3 3 3]; % 3 3 3.75
...
subs_included = subInfo(subInfo.exclusionCode == 0,:);
userOptions.subjectNames = num2cell(subs_included.subNum,28)'; 

function execute_searchlight_feedback(subNum,scriptPath,pred_RDM,userOptions,condition,ss,conditionVec)
...
outputDir = sprintf('%s/CombinedGLM_Feedback_3mm_Multimodel_Searchlight_%dmm_%dss',scriptPath,searchlightRad_mm,ss);
...
mat_file_name = (sprintf('%s/CombinedGLM_Feedback_3mm_Multimodel_Searchlight_%dmm_%dss/%d_searchlight_condition_%d/%d_condition_%d',...

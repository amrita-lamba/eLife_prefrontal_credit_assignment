%% extract coefficents for each participant in specified ROIs during feedback phase 
...
roiPath = [pwd,'/ROI_combinedGLM','/feedback_identity']; % change this for each model

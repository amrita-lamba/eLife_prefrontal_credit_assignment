...
for subIdx = 1:30
    ...
    for condition = 1:2
        ...
        % create contrasts
        execute_searchlight_choice(subNum,scriptPath,pred_RDM,userOptions,condition,ss,conditionVec)
    end 
